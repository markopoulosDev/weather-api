...
<div class="row flex-xl-nowrap">
  <div class="DocSearch-content col-12 col-xl-10 container-p-y">
    <h3 class="mb-4 doc-page-title">
      Αναζήτηση ημερομηνίας
    </h3>
    <div class="col-xl-12">
    <form id="searchData" name="searchData" method="post">
    <div class="mb-3 row">
        <div class="col-lg-3">
            <input class="form-control" type="date" value="2022-05-05" id="date" name="date"/>
          </div>
          <div class="col-lg-3">
          <button type="button" id="searchBtn" class="btn btn-primary">Αναζήτηση</button>
            </div>
        </div>
    ...
    <div class="row">
      <div class="col-12">
        <h4 id="user-location-ex" class="anchor-heading fw-bold">Kavala Weather</h4>
        <div class="doc-example tour-example mt-3">
          <div class="tab-content doc-example-content" id="tab-content" data-label="City Map">
            <div class="tab-pane fade show active" id="ul-map-preview" role="tabpanel" aria-labelledby="ul-map-preview-tab">
    ...
    <div class="row mt-5">
      <div class="col-12">
      <table id="weather_data" class="table table-bordered table-striped">
                  <thead>
                  <tr>

                    <th>Ημερομηνια</th>
                    <th>Θερμοκρασια</th>
                    <th>Μεγιστη θερμοκρασια</th>
                    <th>Ελαχιστη θερμοκρασια</th>
                    <th>Υετος</th>
                    <th>Χιονι</th>
                    <th>Κατευθυνση ανεμου</th>
                    <th>Ταχυτητα ανεμου</th>
